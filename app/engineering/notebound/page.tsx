...
export default function NoteboundPage() {
  useEffect(() => {
  ...
  return (
    <main className="iys-main">
      ...
      <section className="iys-hero">
        ...
        <h1 className="iys-title">Notebound</h1>
      ...
      <section className="iys-section iys-arch" id="architecture">
        ...
        <div className="iys-diagram">
          <svg viewBox="0 0 900 460" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Notebound system architecture">
            <defs>
